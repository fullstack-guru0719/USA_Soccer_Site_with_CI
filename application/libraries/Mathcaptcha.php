...
Class Mathcaptcha
{
    ...
    public function get_question()
    {
        ...
        {       
            ...
            return $this->compile_question($phrase, array($number2, $number1),$operation_symbol);
        }
        else
        {
            //Return the CAPTCHA question
            return $this->compile_question($phrase, array($number1, $number2),$operation_symbol);
        }
    }
     ...
     */
    private function compile_question($phrase, $numbers = array(),$operation_symbol)
    {
        ...
        $question_phrase = $numbers[0] .' '.$operation_symbol.' '.$numbers[1] .' = ';
     
        return $this->create_image($question_phrase);
	...
	{  
	    $fontsize = 16 ;
	    $width    = is_null($width) ? 70 : $width;
	    $height   = is_null($height) ? 20 : $height ;
