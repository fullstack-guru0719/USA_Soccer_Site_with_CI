            ...
            <div class=container>
                <div class=row>
                        ...
                        <div class="<?php echo $logo_col;?>">
                            <?php if(isset($this->settings['footer_logo']) && !empty($this->settings['footer_logo'])):?>
                                <a href="<?php echo base_url();?>">
                                    <img src="<?php echo base_url('uploads/'.$this->settings['footer_logo']);?>" alt="image" />
                                </a>
                            <?php else:?>
                    ...
                    <div class="footer-container text-center col-md-pull-4 <?php echo $icon_col;?>">
                        ...
                        <p><a target="_blank" href="invictvs.net"><font color="white">Created by Invictvs WorldWide Management</font></a></p>
                    </div>
                </div>
            </div>
        </div>
