    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12" style="text-align:center;">
                <h2 class="bannerHeadline"><span>All Tournaments</span></h2>
            </div>
        </div>
    </div>
                                    ...
                                    <a href="#">
                                        <ul class="t_info match_info01 headline01 clearfix">
                                            ...
                                            <li>
                                                ...
                                                <br/>Starts <?php $date = date_create($tournament['start_datetime']); echo date_format($date, 'D\. M jS\. Y g:ia');?>
                                                <br/> Location <?php echo $tournament['tournament_location']; ?>
                                            </li>
                                        </ul>
                                    </a>
                                </li>
