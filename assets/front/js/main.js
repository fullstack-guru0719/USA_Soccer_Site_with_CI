...
$(document).ready(function () {
  ...
  // if($('#galleryWrapper').length){
    ...
    $('.changeVideo11').on('click', function () {
        var $this = $(this);
        var parentli = $this.parent('li');
        parentli.siblings('li').removeClass('active');
        var videourl = $this.data('video-link');
        var video_source = $this.data('video-source');
        var video_type = $this.data('video-type');
        console.log(video_type,'{ "fluid": true,"techOrder": ["'+video_source+'"], "sources": [{ "type": "video/'+video_source+'", "src": "'+videourl+'"}] }');
        ...
        if(video_type == 'internal')
        {
          ...
          $("#my-player").attr(videourl);
          $("#my-player").attr('data-setup','{"fluid": true}');
        }else{
          $("#my-player source").attr(videourl);
          $("#my-player").attr('data-setup','{ "fluid": true,"techOrder": ["'+video_source+'"], "sources": [{ "type": "video/'+video_source+'", "src": "'+videourl+'"}] }');
        }
